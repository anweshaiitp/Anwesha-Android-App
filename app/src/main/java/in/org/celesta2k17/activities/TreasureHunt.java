...
public class TreasureHunt extends AppCompatActivity implements EventsRecyclerViewAdapter.ListCardClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventsRecyclerViewAdapter = new EventsRecyclerViewAdapter(getApplicationContext(), this, resources.getStringArray(R.array.array_treasure_event_headers),
                resources.getStringArray(R.array.array_treasure_event_text),
                resources.getStringArray(R.array.array_treasure_event_rules),
                resources.getStringArray(R.array.array_treasure_event_date_time),
