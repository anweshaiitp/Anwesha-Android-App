...
import info.anwesha2k19.iitp.fragments.LogInFragment;
import info.anwesha2k19.iitp.fragments.SignUpFragment;

import info.anwesha2k19.iitp.R;

import static android.view.View.INVISIBLE;
import static android.view.View.VISIBLE;
import static info.anwesha2k19.iitp.FlexibleFrameLayout.ORDER_LOGIN_STATE;
import static info.anwesha2k19.iitp.FlexibleFrameLayout.ORDER_SIGN_UP_STATE;

public class LoginActivity extends AppCompatActivity {

    private info.anwesha2k19.iitp.databinding.ActivityLoginBinding binding;
        ...
        binding.button.setOnButtonSwitched(isLogin -> {
            binding.getRoot()
                    .setBackgroundColor(ContextCompat.getColor(
                            this,
                            isLogin ? R.color.signUpColor : R.color.loginColor));
        });
    ...
    public void switchFragment(View v) {
        if (isLogin) {
            ...
            getWindow().setStatusBarColor(ContextCompat.getColor(this,R.color.signUpColor));
