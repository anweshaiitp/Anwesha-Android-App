...
import info.anwesha2k19.iitp.adapters.multiCityRecyclerViewAdapter;
import info.anwesha2k19.iitp.data.multiCityData;

import static info.anwesha2k19.iitp.activities.multiCityInfo.EXTRA_DATE_TIME;
import static info.anwesha2k19.iitp.activities.multiCityInfo.EXTRA_HEADER;
import static info.anwesha2k19.iitp.activities.multiCityInfo.EXTRA_IMAGE_ID;
import static info.anwesha2k19.iitp.activities.multiCityInfo.EXTRA_RULES;
import static info.anwesha2k19.iitp.activities.multiCityInfo.EXTRA_VENUE;
...
public class multiCityActivity extends AppCompatActivity implements multiCityRecyclerViewAdapter.ListCardClick {
    ...
    public void onListClick(multiCityData eventsData, View view) throws ClassNotFoundException {
        ...
        Intent intentNew = new Intent(this, Class.forName("info.anwesha2k19.iitp.activities.multiCityInfo"));
