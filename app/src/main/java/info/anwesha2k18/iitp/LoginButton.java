...
public class LoginButton extends View {
    ...
    private void init() {
        ...
        loginButtonPaint.setColor(ContextCompat.getColor(getContext(), R.color.loginColor));
        loginButtonPaint.setStyle(FILL);

        signUpButtonPaint = new Paint();
        signUpButtonPaint.setColor(ContextCompat.getColor(getContext(), R.color.signUpColor));
