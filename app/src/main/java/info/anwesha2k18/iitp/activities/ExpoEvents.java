...
public class ExpoEvents extends AppCompatActivity implements EventsRecyclerViewAdapter.ListCardClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expo_events);
        ...
        eventsRecyclerViewAdapter = new EventsRecyclerViewAdapter(getApplicationContext(), this,
                resources.getStringArray(R.array.array_expo_event_headers),
                resources.getStringArray(R.array.array_expo_event_text),
                resources.getStringArray(R.array.array_expo_event_rules),
                resources.getStringArray(R.array.array_expo_event_date_time),
